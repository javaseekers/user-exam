...
@EnableJpaRepositories(basePackages = "com.exam.result.repository", entityManagerFactoryRef = "resultEntityManager", transactionManagerRef = "resultTransactionManager")
public class ResultConfig
{
	...
	public LocalContainerEntityManagerFactoryBean resultEntityManager()
	{
		...
		em.setPackagesToScan(new String[]{"com.exam.result.entity"});
